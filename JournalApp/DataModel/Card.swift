...
enum Card: Equatable, CaseIterable, Codable {
    ...
    static func title(_ card: Card) -> String {
        switch card {
        case mood(_): return "Mood Tracker"
        case sleep(_): return "Sleep Tracker"
        case sketch(_): return "Doodle"
        case text(_): return "Text Field"
    ...
    static func icon(_ card: Card) -> String {
        switch card {
        case mood(_): return "face.smiling.fill"
        case sleep(_): return "moon.zzz.fill"
        case sketch(_): return "pencil.tip"
        case text(_): return "textformat"
        case photo(_): return "photo.fill"
        }
    }
